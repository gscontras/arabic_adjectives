...
d = d[d$language == "العربية"|d$language == "العربية"|d$language == "العربيه"|d$language == "العربیه"|d$language == "Arabic"|d$language == "Arabic "|d$language == "الغربية Arabic"|d$language == "arabic",]
d = d[d$asses=="Yes",]
